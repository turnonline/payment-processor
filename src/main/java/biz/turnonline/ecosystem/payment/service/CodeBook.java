...
public interface CodeBook
{
     ...
     */
    Map<String, BankCode> getBankCodes( @Nullable Locale locale, @Nullable String country );
     ...
     */
    BankCode getBankCode( @Nonnull String code, @Nullable Locale locale, @Nullable String country );
